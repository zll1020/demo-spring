...
import com.example.spring.demospring.dependency.injection.annotation.InjectedUser;
import com.example.spring.demospring.dependency.injection.annotation.MyAutowired;
...
public class AnnotationDependencyInjectionResolutionDemo {
    ...
    /**
     * 覆盖bean AUTOWIRED_ANNOTATION_PROCESSOR_BEAN_NAME 增加扫描注解类型
     * @return
     */
