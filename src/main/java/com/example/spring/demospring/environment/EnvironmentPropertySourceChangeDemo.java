...
public class EnvironmentPropertySourceChangeDemo {
    ...
    private String userName;
     ...
     // PropertySource("first-property-source") { user.name = lillian-first-property}
     // PropertySource("Java System Properties") { user.name = lillian-system-property }
    ...
    public static void main(String[] args) {
        ...
        source.put("user.name", "lillian-main");
